...
-- INSERT, UPDATE, DELETE 작업 내용을 실제 DB에 저장한다.
...
DELETE FROM MEMBER_TBL WHERE MEMNO = 1001;
--  지정된 MEMNO값에 해당하는 칼럼 값들 수정하기
UPDATE MEMBER_TBL SET pass='1111' WHERE memno = 1001;

SELECT * FROM MEMBER_TBL WHERE memno = 1002;